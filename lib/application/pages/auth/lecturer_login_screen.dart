...
class LecturerLoginScreenWrapperProvider extends StatelessWidget {
  const LecturerLoginScreenWrapperProvider({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<LoginCubit>(),
      child: const LecturerLoginScreen(),
    );
  }
}
      ...
      body: BlocListener<LoginCubit, LoginState>(
        listener: (context, state) async {
          if (state is LoginSuccess) {
            print('📍 Lecturer login success, navigating to: ${state.redirectRoute}');
            ...
            // Simple navigation - the router's redirect logic will handle auth verification
            if (context.mounted) {
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        const SizedBox(height: 4),
                                        Text(
                                          'Use the credentials provided by your administrator. Contact IT support if you need assistance.',
                                          style: textTheme.bodySmall?.copyWith(
                                            color: theme.colorScheme.onSurface.withValues(alpha: 0.7),
                                            height: 1.4,
                                          ),
  ...
  void _showForgotPasswordDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Please contact the system administrator or your department head to reset your password.'),
        actions: [
          TextButton(
